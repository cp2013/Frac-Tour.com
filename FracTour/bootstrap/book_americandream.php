...
<div class="container">
    ...
    <div class="jumbotron">
        <h3 class="heading-content">Tour Destination : American Dream (11 Days 9 Nights)</h3>
        <p style="font-family:Arial, Helvetica, sans-serif; color:#F90; font-size:22px;"><strong>Price: $1850</strong></p>            
        <hr/>     
            ...
            <div class="tab-pane active" id="booking">
                ...
                <form class="form-horizontal" role="form" id="bookform" name="bookform" method="post" action="booking.php">
                	<div class="form-group">
                        ...
                        <div class="col-md-3"><input name="tourcode" type="text" maxlength="10" class="form-control" value="US119" readonly="readonly"></div>                            
                    </div>
                	...
                	<div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <p class="help-block">This tour is valid until 25 November 2014</p>
                        </div>
                    </div>
