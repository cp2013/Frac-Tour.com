...
<div class="container">
    ...
    <div class="jumbotron">
        <h3 class="heading-content">Tour Destination : Korea Jeju (7 Days 6 Nights)</h3>
        <p style="font-family:Arial, Helvetica, sans-serif; color:#F90; font-size:22px;"><strong>Price: $1800</strong></p>            
        <hr/>     
            ...
            <div class="tab-pane active" id="booking">
                ...
                <form class="form-horizontal" role="form" id="bookform" name="bookform" method="post" action="booking.php">
                	<div class="form-group">
                        ...
                        <div class="col-md-3"><input name="tourcode" type="text" maxlength="10" class="form-control" value="KR76" readonly="readonly"></div>                            
                    </div>
                	...
                	<div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <p class="help-block">This tour is valid until 10 November 2014</p>
                        </div>
                    </div>
